Ferramenta de Controle de Investimentos em Fundos Imobiliários (FIIs)
...
> **Aplicar os conceitos de Excel na criação de uma planilha capaz de simular diferentes cenários de investimentos em Fundos Imobiliários**, ajudando investidores a tomarem decisões mais informadas sobre aportes, tempo de investimento, rentabilidade e dividendos esperados.

**Perguntas que a ferramenta ajuda a responder:**

* Quanto investir por mês?
* Qual o impacto da taxa de rendimento?
* Qual a porcentagem aplicar? Levando em consideração seu perfil de investimento
...
* Aplicar **cálculos financeiros**, como rendimento composto e dividendos mensais e anuais;
...
* Simulação de aportes mensais e evolução patrimonial
* Cálculos automáticos dos rendimentos composto e dividendos mensais
* Estimativa do valor total investido e do retorno futuro
* Dashboard com gráficos dinâmicos e visão geral da carteira
* Layout ideal para iniciantes e investidores em aprendizado
...
1. Faça o download deste repositório:
   ...
   ```bash
   git clone https://github.com/seu-usuario/Ferramenta-Controle-Fundo-Imobiliario.git
   ```
...
Email: fabricio.marinheiro@hotmail.com
